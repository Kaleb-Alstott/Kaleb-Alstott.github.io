...
function hideInputs(){
    ...
    $('#affineCipher').addClass("d-none");//ADDED THIS LINE
...
function cipherChange(){
    ...
    switch (document.getElementById('cipherSelect').value){
        case 'Affine':
            $('#affineCipher').removeClass("d-none");//ADDED LINE
            break;
        case 'AutoKey':
            break;
        case 'Caesar':
            $('#caesarCipher').removeClass("d-none");
            $('#caesarBruteForce').removeClass("d-none");
            break;
        ...
        case 'Multiplicative':
            ...
            $('#multiplicativeBruteForce').removeClass("d-none");
            break;
    }
}